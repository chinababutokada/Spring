...
public class CustomPropertyEditors {
	...
	public static void main(String[] args) {
		...
		factory.addPropertyEditorRegistrar(new CustomPropertyRegister());
   ...
   private static class CustomPropertyRegister implements PropertyEditorRegistrar{

	@Override
	public void registerCustomEditors(PropertyEditorRegistry registry) {
		System.out.println("CustomPropertyEditors.CustomPropertyRegister.registerCustomEditors()");
